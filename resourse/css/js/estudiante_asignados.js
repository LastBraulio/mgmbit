$(document).ready(function() {
            ...
            var datatable = $('#dataTable').DataTable({
                ajax: "estudiante.php?m=ajaxtabla_3",
                columns: [
                    {data2:"0"},
                    {data2:"1"},
                    {data2:"2"},
                    ...
                    {
                        data: null,
                        defaultContent: '<a id="kardes" class="btn btn-success  btn-sm" ><i class="fas fa-edit">Ver Información</i></a>'
                    }
                ],
                "language": { 
			      "emptyTable": "No hay Estudiante Para Asignar Materias..."
			    }
            });
           ...
           /* var datatable2 = $('#dataTable2').DataTable({
                ajax: "estudiante.php?m=ajaxtabla_asignados",
                columns: [
                    {data2:"0"},
                    {data2:"1"},
                    {data2:"2"},
			...
			$('#btm_guardar').on('click',function(){
				$.ajax({
					  url:"estudiante.php?m=asignar_materias_estudiante",
					  type: "POST",
					  data: {
			...
			$.ajax({
				type: "GET",
				url: 'estudiante.php?m=get_materia', 
				dataType: "json",
			...
			// combobox 2 InputGradocss
				$.ajax({
					type: "GET",
					url: 'estudiante.php?m=get_grado', 
					dataType: "json",
					success: function(data){
					  $.each(data,function(key, registro) {
			...
			// combobox 3 InputTipClientcss_u
				$.ajax({
					type: "GET",
					url: 'estudiante.php?m=get_jornada', 
					dataType: "json",
					success: function(data){
					  $.each(data,function(key, registro) {
