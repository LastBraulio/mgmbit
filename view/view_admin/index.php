...
<html lang="en">
  <head>
    ...
    <link href="http://localhost/start/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">

    <!--<link href="http://localhost/start/css/sb-admin-2.min.css" rel="stylesheet">-->
        ...
        <ul class="nav flex-column ">
          <li class="nav-item">
            <a class="nav-link " href="#">
              <b><span data-feather="home"></span>
              Dashboard <span class="sr-only"></span>
            </a></b>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#">
              <b><span data-feather="file"></span>
              Orders</b>
            </a>
          </li>
          <li class="nav-item">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Earnings (Annual)</div>
...
<script src="https://code.jquery.com/jquery-3.5.1.slim.min.js" integrity="sha384-DfXdz2htPH0lsSSs5nCTpuj/zy4C+OGpamoFVy38MVBnE+IbbVYUew+OrCXaRkfj" crossorigin="anonymous"></script>
      <script>window.jQuery || document.write('<script src="../assets/js/vendor/jquery.slim.min.js"><\/script>')</script><script src="https://getbootstrap.com/docs/4.5/dist/js/bootstrap.bundle.min.js"></script>
        ...
        <script src="resourse/js/dashboard.js"></script>
</body>
</html>
