...
Class Modelo_notas extends Conexiones{
	public $tabla = "countries";
	
	public function mostrar_ajax($cedula)
	{
		//$sentencia = "select * from countries";
		$sentencia = "select t3.id_tareas,t2.nom_materia, t3.nombre_tarea , t3.descripcion, t3.puntuacion, t5.calificacion, t5.porcentaje , t5.observacion, t3.fecha_entrega , t4.nombre from view_asignarprofe_estudiante t1, materia t2 ,tareas t3, usuarios t4, notas t5 where t1.id_materia = t3.id_materia and t1.id_grado = t3.id_grado and t1.id_jornada = t3.id_jornada and t3.id_tareas = t5.id_tarea and t1.id_materia = t2.id_materia and t1.ced_profesor = t4.cedula and t1.cedula_stu = '$cedula' and t3.cerrar_tarea = 2;";
		//var_dump($this->pdo);
		//exit;
